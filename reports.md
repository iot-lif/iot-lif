...
<figure>
<img src="brevitas-graphic.png" alt="Overview of software parts for the project." style="width:50.0%" /><figcaption>Overview of software parts for the project.</figcaption>
...
<figure>
<img src="spiking-layers.png" alt="Simplified view of a convolutional DCLL spiking layer." style="width:80.0%" /><figcaption>Simplified view of a convolutional DCLL spiking layer.</figcaption>
...
<figure>
<img src="radioml.png" alt="A visualization of image discretizations for I/Q samples." style="width:80.0%" /><figcaption>A visualization of image discretizations for I/Q samples.</figcaption>
...
<figure>
<img src="network.png" alt="High-level overview of network architecture." style="width:80.0%" /><figcaption>High-level overview of network architecture.</figcaption>
...
<figure>
<img src="results_Jun12_06-28-21.png" alt="Per-layer classification accuracies at different SNRs." /><figcaption>Per-layer classification accuracies at different SNRs.</figcaption>
...
<figure>
<img src="quantization.png" alt="Architecture of quantized layer." style="width:80.0%" /><figcaption>Architecture of quantized layer.</figcaption>
</figure>Conclusion
==========
...
<img src="rml_snn_acc3.png" title="fig:" alt="An example of the training process on RadioML for each of three convolutional DECOLLE SNN layers. The plots depict mean validation accuracy over time." /> 
<img src="rml_snn_acc2.png" title="fig:" alt="An example of the training process on RadioML for each of three convolutional DECOLLE SNN layers. The plots depict mean validation accuracy over time." /> 
<img src="rml_snn_acc1.png" title="fig:" alt="An example of the training process on RadioML for each of three convolutional DECOLLE SNN layers. The plots depict mean validation accuracy over time." />
